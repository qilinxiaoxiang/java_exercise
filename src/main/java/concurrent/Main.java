...
public class Main {
    public static void main(String[] args) {
        ...
        Thread printerA = new Thread(new SyncPrinter(lock, printA, printB, 'A'));
        Thread printerB = new Thread(new SyncPrinter(lock, printB, printC, 'B'));
        Thread printerC = new Thread(new SyncPrinter(lock, printC, printA, 'C'));
